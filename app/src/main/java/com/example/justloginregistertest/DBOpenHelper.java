 ...
 */
// DBOpenHelper必须得继承SQLiteOpenHelper类，才能重写它的方法。这个SQLiteOpenHelper类是安卓自带的类
public class DBOpenHelper extends SQLiteOpenHelper {
     ...
     * getAllData()
     */
    public void add(String name,String password,String identity){
        db.execSQL("INSERT INTO user (name,password,identity) VALUES(?,?)",new Object[]{name,password,identity});
    }
    public void delete(String name,String password,String identity){
        db.execSQL("DELETE FROM user WHERE name = AND password ="+name+password+identity);
    }
    ...
    public ArrayList<User> getAllData(){
        ...
        while(cursor.moveToNext()){
            ...
            list.add(new User(name,password,identity));
        }
        //游标用完得关闭，如果不关闭，就会占很大的内存，毕竟手机的内存都是有限的
        cursor.close();
        return list;
    }
}
